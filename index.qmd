...
Before trying to install the software, please complete the [basic health check](./req/health.qmd) to ensure that your computer is up-to-date and able to run the software we use.
...
The [Setup](./setup/index.qmd) section will help you to get your computer ready for the workshop.
