...
[Constituency cards](http://www.statsmapsnpix.com/2019/08/constituency-cards.html) are 'scripted' in QGIS:

![](img/Constituency-Walthamstow.png)
![](img/Constituency-Brighton.png)
![](img/Constituency-Aldridge.png)

Source: [github.com/alasdairrae/wpc](https://github.com/alasdairrae/wpc)
...
::: {.column width="49%"}
![No Class Breaks](img/Employment-No_Class.png){width="100%"}
:::

::: {.column width="49%"}
![3 Quantiles](img/Employment-3_Quantiles.png){width="100%"}
:::
...
::: {.column width="49%"}
![7 Quantiles](img/Employment-7_Quantiles.png){width="100%"}
:::

::: {.column width="49%"}
![7 Equal Interval](img/Employment-7_Equal.png){width="100%"}
:::
...
::: {.column width="49%"}
![7 Pretty Breaks](img/Employment-7_Pretty.png){width="100%"}
:::

::: {.column width="49%"}
![7 Natural Breaks](img/Employment-7_Natural.png){width="100%"}
:::
