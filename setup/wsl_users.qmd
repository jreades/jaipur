...
Some students may either a) run into problems that *require* a Linux user to correct; or b) wish to go further with WSL and Linux. You do not (normally) need this to run Podman or Docker.
